...
import { Route as TraversalRouteImport } from './routes/traversal'
...
const TraversalRoute = TraversalRouteImport.update({
  id: '/traversal',
  path: '/traversal',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/traversal': typeof TraversalRoute
...
export interface RootRouteChildren {
  ...
  TraversalRoute: typeof TraversalRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/traversal': {
      ...
      path: '/traversal'
      fullPath: '/traversal'
      preLoaderRoute: typeof TraversalRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/settings': {
      id: '/settings'
